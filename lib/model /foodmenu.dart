...
List<Foodmenu> foodmenuFromJson(String str) =>
    List<Foodmenu>.from(json.decode(str).map((x) => Foodmenu.fromJson(x)));

String foodmenuToJson(List<Foodmenu> data) =>
...
class Foodmenu {
  ...
  static List<Foodmenu> fromList(dynamic json) {
    List<Foodmenu> list = [];
    if (json != null && json is List) {
      for (var item in json) {
        list.add(Foodmenu.fromJson(item));
      }
    }
    return list;
  }
